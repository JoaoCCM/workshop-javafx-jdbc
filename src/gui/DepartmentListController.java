...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		...
		tableViewDepartment.prefHeightProperty().bind(stage.heightProperty()); // macete pra fazer a viewTable
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parentStage) {
		try {
			...
			dialogStage.initModality(Modality.WINDOW_MODAL);// impede usuario de mexer na tela anterior enquanto essa
															// nova estiver aberta
